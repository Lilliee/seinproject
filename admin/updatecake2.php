...
$sql="select * from cake where CakeID='$cid'";
...
<h2>Fill in this from to Update the Cakes</h2>
<ul>
<li>
    <input type="text" name="cname" class="field-style field-split align-left" placeholder="Enter Cake Name" value="<?php echo $cname;?>"/>
...
if($_FILES['file']['name']=="")
    {
  $sql="update cake SET Name='$name1', Price='$price1' where CakeID='$cid'";
  $db1->exec($sql);
...
else
{
    ...
    $sql="update cake SET Name='$name1', Price='$price1', Image='$image' where CakeID='$cid'";
    $db1->exec($sql);
   // echo "updated successfully";
