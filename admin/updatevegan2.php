...
$sql="select * from vegan where VeganID='$vid'";
...
<h2>Fill in this from to Update the foods</h2>
<ul>
<li>
    <input type="text" name="vname" class="field-style field-split align-left" placeholder="Enter Food Name" value="<?php echo $vname;?>"/>
...
if($_FILES['file']['name']=="")
    {
  $sql="update vegan SET Name='$name1', Price='$price1' where VeganID='$vid'";
  $db1->exec($sql);
...
else
{
    ...
    $sql="update vegan SET Name='$name1', Price='$price1', Image='$image' where VeganID='$vid'";
    $db1->exec($sql);
   // echo "updated successfully";
