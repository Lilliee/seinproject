...
$sql="select * from soup where SoupID='$sid'";
...
<h2>Fill in this from to Update the Soups</h2>
<ul>
<li>
    <input type="text" name="sname" class="field-style field-split align-left" placeholder="Enter Soup Name" value="<?php echo $sname;?>"/>
...
if($_FILES['file']['name']=="")
    {
  $sql="update soup SET Name='$name1', Price='$price1' where SoupID='$sid'";
  $db1->exec($sql);
...
else
{
    ...
    $sql="update soup SET Name='$name1', Price='$price1', Image='$image' where SoupID='$sid'";
    $db1->exec($sql);
   // echo "updated successfully";
